...
- **Phase 5 → `plans/done/flue-agent.md`** — a codebase-aware conversational agent (Flue) that grounds authoring in the actual repo and can ask clarifying questions during create/move.
...
**Phases 5 & 6 were split into their own plans** as the CMS work wrapped — see `plans/done/flue-agent.md` (the conversational, codebase-aware Flue agent) and `plans/backlog/multi-user-and-launch.md` (quotas, rate limits, org/team, audit UI, launch).
...
- **Phase 5 & 6 split into their own plans** — `plans/done/flue-agent.md`, `plans/backlog/multi-user-and-launch.md`.
